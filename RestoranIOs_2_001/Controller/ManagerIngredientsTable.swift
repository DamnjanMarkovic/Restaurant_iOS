...
UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var pickerIngredients = UIPickerView()
   
    
    @IBOutlet weak var lblIngredientNamePicker: UILabel!
    
    @IBAction func clickRestaurant(_ sender: UITextField) {
        print("nesto")
    }
...
//        }
    ...
    func createPickerIngredient() {
        pickerIngredients = UIPickerView()
        ...
        for ingr in allIngredients {
            if (ingr.ingredient_name == tfPickerNameIngredient.text){
                ...
                if (availableString != nil ){
                    lblQuantityAvailableInfo.text = availableString! + " " + ingr.quantity_measure
                    + " available"
                }
                else {
